...
def extracts(file1,drec):
    ...
    if (not os.path.exists
        ...
        print("PDT")
        os.system(r"python   acc.pyc " + file1 + " Protein PDT -out " + drec + filename + "feature-PDT.csv -f csv")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-PC-PseAAC.csv")):
        ...
        print("PC-PseAAC")
        os.system(
            r"python pse.pyc " + file1 + " Protein PC-PseAAC -out " + drec + filename + "feature-PC-PseAAC.csv -f csv")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-SC-PseAAC.csv")):
        ...
        print("SC-PseAAC")
        os.system(
            r"python pse.pyc " + file1 + " Protein SC-PseAAC -out " + drec + filename + "feature-SC-PseAAC.csv -f csv")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-PC-PseAAC-General.csv")):
        ...
        os.system(
            r"python  pse.pyc " + file1 + " Protein PC-PseAAC-General -out " + drec + filename + "feature-PC-PseAAC-General.csv -f csv")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-SC-PseAAC-General.csv")):
        ...
        os.system(
            r"python  pse.pyc " + file1 + " Protein SC-PseAAC-General -out " + drec + filename + "feature-SC-PseAAC-General.csv -f csv")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-AC-PSSM.csv")):
        print("AC-PSSM ")
        os.system(
            r"python    profile.pyc " + file1 + " AC-PSSM -out " + drec + filename + "feature-AC-PSSM.csv -f csv ")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-Top-n-gram.csv")):
        print("Top-n-gram")
        os.system(
            "python  profile.pyc " + file1 + " Top-n-gram -out " + drec + filename + "feature-Top-n-gram.csv -f csv -n 2 ")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-PDT-Profile.csv")):
        print("PDT-Profile")
        os.system(
            "python profile.pyc " + file1 + " PDT-Profile -out " + drec + filename + "feature-PDT-Profile.csv -f csv -n 2 ")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-CC-PSSM.csv")):
        ...
        print("CC-PSSM")
        os.system(
            "python profile.pyc " + file1 + " CC-PSSM -out " + drec + filename + "feature-CC-PSSM.csv -f csv")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-ACC-PSSM.csv")):
        print("ACC-PSSM")
        os.system(
            "python profile.pyc " + file1 + " ACC-PSSM -out " + drec + filename + "feature-ACC-PSSM.csv -f csv ")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-PSSM-DT.csv")):
        print("PSSM-DT")
        os.system(
            "python profile.pyc " + file1 + " PSSM-DT -out " + drec + filename + "feature-PSSM-DT.csv -f csv ")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-PSSM-RT.csv")):
        print("PSSM-RT")
        os.system(
            "python profile.pyc " + file1 + " PSSM-RT  -out " + drec + filename + "feature-PSSM-RT.csv -f csv")
    else:
        pass
    ...
    if (not os.path.exists(drec + filename + "feature-DT.csv")):
        print("DT")
        os.system(r"python profile.pyc " + file1 + " DT -out " + drec + filename + "feature-DT.csv -f csv ")
    else:
        pass
